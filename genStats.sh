...
python2 $home/stats_gen/sss_desertbus/splitLogs.py -f $home/.weechat/logs/irc.dbchat.\#desertbus.weechatlog -p $home/stats_gen/working_logs/newserver.desertbus. -s .weechatlog
